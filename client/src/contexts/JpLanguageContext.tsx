...
const translations: Record<Language, Translations> = {
  ja: {
    ...
    hero: {
      tagline: "日本発、未来を創るビジネスソリューション",
      headline1: "多角的な事業展開で",
      headline2: "価値を創造する",
      subtitle: "不動産管理から飲食、フィットネス、宿泊、人材まで。Tengcle Inc.は日本市場において多様なサービスを提供し、お客様の生活とビジネスを支えます。",
      cta1: "事業内容を見る",
      cta2: "お問い合わせ",
      trust1: "日本法人",
      trust2: "グループ企業",
    ...
    services: {
      subtitle: "事業内容",
      title: "5つの事業領域",
      description: "不動産、飲食、フィットネス、宿泊、人材の5つの分野で、お客様のニーズに応える高品質なサービスを提供しています。",
      viewAll: "詳細を見る",
      realEstate: {
        title: "不動産管理",
        description: "賃貸物件の管理・運営から、オーナー様への収益最大化のご提案まで。入居者様とオーナー様の双方にご満足いただける不動産管理サービスを提供します。",
      },
      restaurant: {
        title: "飲食店オペレーション",
        description: "レストラン・カフェの企画・運営から、店舗開発、メニュー開発、スタッフ教育まで。飲食ビジネスの成功をトータルでサポートします。",
      },
      gym: {
        title: "レンタルジム",
        description: "プライベート空間で集中してトレーニングできるレンタルジムを運営。最新の設備と清潔な環境で、お客様の健康づくりをサポートします。",
      },
      capsuleHotel: {
        title: "カプセルホテル運営",
        description: "快適性と機能性を追求した次世代カプセルホテルを運営。ビジネス・観光のお客様に、リーズナブルで質の高い宿泊体験を提供します。",
      },
      recruitment: {
        title: "人材紹介",
        description: "企業と求職者の最適なマッチングを実現。業界知識と豊富なネットワークを活かし、双方にとって価値ある出会いを創出します。",
      },
    },
    about: {
      subtitle: "会社概要",
      title: "Tengcle Inc.について",
      description: "Tengcle Inc.は、香港に本社を置くTengcle Limitedの日本法人として、日本市場において多角的な事業を展開しています。",
      story: {
        title: "私たちについて",
        p1: "Tengcle Inc.は、香港を拠点とするTengcle Limitedグループの一員として、日本市場における事業展開を担っています。",
        p2: "不動産管理、飲食店オペレーション、レンタルジム、カプセルホテル運営、人材紹介の5つの事業を通じて、日本の皆様の生活とビジネスに貢献しています。",
      },
      info: {
        title: "会社情報",
        legalName: "法人名",
      ...
      philosophy: {
        title: "私たちの理念",
        mission: "ミッション",
        missionText: "多角的な事業展開を通じて、お客様の生活とビジネスに新たな価値を創造し、社会の発展に貢献します。",
        values: "バリュー",
        valuesText: "誠実さ、品質へのこだわり、そしてお客様第一の姿勢。これらの価値観を大切にし、信頼されるパートナーであり続けます。",
      },
    },
    contact: {
      subtitle: "お問い合わせ",
  ...
  en: {
    ...
    hero: {
      tagline: "Business Solutions from Japan",
      headline1: "Creating Value Through",
      headline2: "Diversified Business",
      subtitle: "From real estate to dining, fitness, accommodation, and recruitment. Tengcle Inc. provides diverse services in the Japanese market to support your life and business.",
      cta1: "View Our Services",
      cta2: "Contact Us",
      trust1: "Japan Corporation",
      trust2: "Group Company",
      trust3: "Diversified Business",
    },
    services: {
      subtitle: "Our Services",
      title: "Five Business Areas",
      description: "We provide high-quality services across five sectors: real estate, dining, fitness, accommodation, and recruitment.",
      viewAll: "Learn More",
      realEstate: {
        title: "Real Estate Management",
        description: "From rental property management to revenue maximization proposals for owners. We provide real estate management services that satisfy both tenants and property owners.",
      },
      restaurant: {
        title: "Restaurant Operations",
        description: "From restaurant and cafe planning to store development, menu creation, and staff training. We provide total support for food service business success.",
      },
      gym: {
        title: "Rental Gym",
        description: "We operate rental gyms where you can focus on training in a private space. Supporting your health with the latest equipment and clean environment.",
      },
      capsuleHotel: {
        title: "Capsule Hotel Operations",
        description: "Operating next-generation capsule hotels pursuing comfort and functionality. Providing affordable, high-quality accommodation for business and leisure travelers.",
      },
      recruitment: {
        title: "Recruitment Services",
        description: "Achieving optimal matching between companies and job seekers. Creating valuable connections for both parties through industry knowledge and extensive networks.",
      },
    },
    about: {
      subtitle: "About Us",
      title: "About Tengcle Inc.",
      description: "Tengcle Inc. is the Japanese subsidiary of Tengcle Limited, headquartered in Hong Kong, operating diversified businesses in the Japanese market.",
      story: {
        title: "Our Story",
        p1: "Tengcle Inc. is a member of the Tengcle Limited group based in Hong Kong, responsible for business development in the Japanese market.",
        p2: "Through five business areas - real estate management, restaurant operations, rental gyms, capsule hotel operations, and recruitment services - we contribute to the lives and businesses of people in Japan.",
      },
      info: {
      ...
      philosophy: {
        ...
        mission: "Mission",
        missionText: "Creating new value for customers' lives and businesses through diversified operations, contributing to social development.",
        values: "Values",
        valuesText: "Integrity, commitment to quality, and customer-first attitude. We cherish these values and remain a trusted partner.",
      },
    },
    contact: {
      subtitle: "Contact Us",
