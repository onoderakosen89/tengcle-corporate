...
const translations: Record<Language, Translations> = {
  en: {
    ...
    trust: {
      ...
      description: "We prioritize transparent coordination, clear scope definition, and responsible project delivery as our operations develop.",
  ...
  ja: {
    ...
    trust: {
      ...
      title: "誠実な運営",
      description: "透明性のある調整、明確な業務範囲、責任あるプロジェクト遂行を大切にしています。",
      established: "設立",
  ...
  zh: {
    ...
    trust: {
      subtitle: "信任与合规",
      title: "诚信经营",
      description: "我们重视透明协调、清晰的工作范围和负责任的项目执行。",
      established: "成立",
