...
const faqData: Record<string, FAQItem[]> = {
  en: [
    ...
    },
    {
      ...
      answer: "Tengcle Group operates globally with offices in three key regions: Hong Kong (Global Headquarters - Tengcle Limited), Japan (Tengcle Inc. - Tokyo), and the United States (Tengcle Development LLC - New Jersey). We serve clients throughout Asia-Pacific, including China, Southeast Asia, and beyond."
    },
    {
  ...
  ja: [
    ...
    },
    {
      ...
      answer: "Tengcle Groupは、3つの主要地域にオフィスを構えてグローバルに事業を展開しています：香港（グローバル本社 - Tengcle Limited）、日本（Tengcle Inc. - 東京）、アメリカ（Tengcle Development LLC - ニュージャージー）。中国、東南アジアを含むアジア太平洋地域全体のお客様にサービスを提供しています。"
    },
    {
  ...
  zh: [
    ...
    },
    {
      ...
      answer: "Tengcle Group在三个主要地区设有办事处，进行全球运营：香港（全球总部 - Tengcle Limited）、日本（Tengcle Inc. - 东京）和美国（Tengcle Development LLC - 新泽西）。我们为包括中国、东南亚在内的整个亚太地区的客户提供服务。"
    },
    {
