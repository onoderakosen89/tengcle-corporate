...
const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    excerpt: {
      en: "Tengcle Development LLC is scheduled to be officially registered in Weehawken, New Jersey in January 2026 as the US office of Tengcle Group.",
      ja: "Tengcle Development LLCは、2026年1月にTengcle Groupの米国拠点としてニュージャージー州ウィーホーケンに正式登記予定です。",
      zh: "Tengcle Development LLC计划于2026年1月作为Tengcle Group的美国办事处在新泽西州威霍肯正式注册。"
    },
    content: {
      en: [
        "Tengcle Development LLC is scheduled to be officially registered in Weehawken, New Jersey in January 2026 as the US office of Tengcle Group, marking the group's expansion into the North American market.",
      ...
      ja: [
        "Tengcle Development LLCは、2026年1月にTengcle Groupの米国拠点としてニュージャージー州ウィーホーケンに正式登記予定です。グループの北米市場への進出を示すものです。",
      ...
      zh: [
        "Tengcle Development LLC计划于2026年1月作为Tengcle Group的美国办事处在新泽西州威霍肯正式注册，标志着集团进军北美市场。",
  ...
  },
  {
    ...
    content: {
      en: [
        ...
        "Tengcle株式会社 in Tokyo serves as the group's founding entity, offering property management, F&B operations, rental gyms, capsule hotels, and staffing services in the Japanese market.",
      ...
      ja: [
        ...
        "東京のTengcle株式会社はグループの創業法人として、日本市場で不動産管理、飲食事業、レンタルジム、カプセルホテル、人材紹介サービスを提供しています。",
      ...
      zh: [
        ...
        "东京的Tengcle株式会社是集团的创始实体，在日本市场提供物业管理、餐饮运营、租赁健身房、胶囊酒店和人才介绍服务。",
