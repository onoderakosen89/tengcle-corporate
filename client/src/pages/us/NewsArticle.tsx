...
const newsArticles: NewsArticle[] = [
  {
    ...
    excerpt: {
      en: "Tengcle LLC begins full-scale property management operations in New Jersey and the New York metro area.",
      ja: "Tengcle LLCは、ニュージャージー州およびニューヨーク都市圏で不動産管理事業を本格的に開始しました。",
      zh: "Tengcle LLC在新泽西州和纽约都市圈正式启动不动产管理业务。"
    },
    content: {
      en: [
        "Tengcle LLC begins full-scale property management operations in New Jersey and the New York metro area, offering comprehensive services for property owners and investors.",
      ...
      ja: [
        "Tengcle LLCは、ニュージャージー州およびニューヨーク都市圏で不動産管理事業を本格的に開始しました。物件オーナーや投資家向けに包括的なサービスを提供します。",
      ...
      zh: [
        "Tengcle LLC在新泽西州和纽约都市圈正式启动不动产管理业务，为业主和投资者提供综合服务。",
  ...
  },
  {
    ...
    excerpt: {
      en: "With the establishment of Tengcle LLC, Tengcle Group now operates from three locations.",
      ja: "Tengcle LLCの設立により、Tengcle Groupは3拠点体制となりました。",
      zh: "随着Tengcle LLC的成立，Tengcle Group现已在三地运营。"
    },
    content: {
      en: [
        "With the establishment of Tengcle LLC, Tengcle Group now operates from three locations: Tokyo, Hong Kong, and New Jersey, enabling comprehensive global service delivery.",
        "Tengcle Inc. in Tokyo serves as the group's founding entity, offering property management, F&B operations, rental gyms, capsule hotels, and staffing services in the Japanese market.",
      ...
      ja: [
        "Tengcle LLCの設立により、Tengcle Groupは東京、香港、ニュージャージーの3拠点体制となり、グローバルなサービス提供が可能になりました。",
        "東京のTengcle Inc.はグループの創業法人として、日本市場で不動産管理、飲食事業、レンタルジム、カプセルホテル、人材紹介サービスを提供しています。",
      ...
      zh: [
        "随着Tengcle LLC的成立，Tengcle Group现已在东京、香港和新泽西三地运营，实现全球化服务。",
        "东京的Tengcle Inc.是集团的创始实体，在日本市场提供物业管理、餐饮运营、租赁健身房、胶囊酒店和人才介绍服务。",
...
export default function NewsArticle() {
  ...
  return (
    <>
      <SEOHead
        title={`${article.title[language as keyof typeof article.title]} | Tengcle LLC`}
