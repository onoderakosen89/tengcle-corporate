...
| Hong Kong | `Tengcle Limited`; incorporated `2025-04-29`; Business Registration Number `78077104` | [Hong Kong Companies Registry new-incorporation list, 28 April–4 May 2025, p. 327](https://www.cr.gov.hk/docs/wrpt/RNC063_2025.04.28-2025.05.04.pdf#page=327) | Public UI, metadata, JSON-LD, and generated assets use the legal name, jurisdiction, and incorporation date but omit the registration number. Address and contact channels are excluded from Organization JSON-LD. |
| United States | `Tengcle Development LLC`; formed in New Jersey `2026-01-05`; Entity ID `0451392806` | Reviewed formation packet and operating agreement retained in the internal legal-record store. No private document is copied into this public repository. | Public UI, metadata, JSON-LD, and generated assets use the legal name, jurisdiction, and formation date but omit the entity ID. Address and contact channels are excluded from Organization JSON-LD. |
